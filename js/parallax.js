...
var parallax = function () {
            ...
            if (testMobile == null) {
                $(".parallax").parallax("50%", 0.02);
//                 $(".parallax-column > .elementor-widget-wrap").parallax("50%", 0.3);
//                  $(".parallax-overlay  .elementor-background-overlay").parallax("50%", 0.3);
        ...
        $(function () {
            if($(".parallax").length){
                console.log('parallax 2 is ready');
            parallax();
        }
        });
    })(jQuery);
        ...
        t.resize(function () {
            ...
            function u() {
                ...
                l.each(function (t, u) {
                    ...
                    i > f + s || f > i + e || l.css("backgroundPosition", o + " " + (50 - Math.round((l.data("firstTop") - i) * r)) + "%")
                })
            }
            var a, l = n(this);
            l.each(function (t, e) {
