...
//        }
    ...
    jQuery(document).on('ready', function () {
        ...
        //'<script async defer crossorigin="anonymous" src="//connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v6.0&appId=194942155100100&autoLogAppEvents=1"></script>'+
                ...
                '<script async defer   src="//cdn.chatbot.com/widget/plugin.js"></script>' +
...
//}
            ...
            if ($(ID).length) {
                ...
                var adScript = '<script>googletag.cmd.push(function(){'+scr+'});</script>';
                setTimeout(function () {
         //   jQuery(adScript).appendTo(jQuery('head'));
        }, 2100);
            }
...
console.log(adScript);
        ...
        loadElementAdsJs('#div-gpt-ad-1590747775307-0', 'googletag.defineSlot("/22025122300/topbanner", [300, 250], "div-gpt-ad-1590747775307-0").addService(googletag.pubads());');
        ...
        function loadElementAdsDisplay(ID, controller) {
            ...
            if (el.length) {
                ...
                var tempSrc = '<script>googletag.cmd.push(function(){googletag.display("' + ID + '")};</script>';
                      setTimeout(function () {
        //    jQuery(tempSrc).appendTo(jQuery('head'));
        }, 2300);
                    }
