 ...
 * @package bbPress
 * @subpackage Theme
 * agespace/topic/test-topic-here/
 */
?>
<?php bbp_breadcrumb(); ?>
  ...
  <section id="question" class="goto-top-breakpoint">
    ...
    <div class="questionmeta">
      ...
      <div class="communityQuestionMeta">
        <div class="askedby">
          <div class="username">Asked by <span  itemprop="author" itemscope="" itemtype="http://schema.org/Person">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
          <div class="question-actions links">
            <a class="answer-link le-btn" href="#new-post">Answer this question</a>
...
<?php if (bbp_has_replies()) : ?>
  ...
  <?php get_template_part('section', 'answerform'); ?>
  <?php //get_template_part('section', 'askform'); ?>
